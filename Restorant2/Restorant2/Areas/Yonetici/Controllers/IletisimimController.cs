...
namespace Restorant2.Areas.Yonetici.Controllers
{
    ...
    public class IletisimimController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Teledon,Adres")] Iletisimim iletisimim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Teledon,Adres")] Iletisimim iletisimim)
        {
            if (id != iletisimim.Id)
            {
                return NotFound();
